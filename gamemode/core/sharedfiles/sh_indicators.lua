if CLIENT then
	...
	surface.CreateFont( "DmgIndicator" ,
	{ font = "D3 Euronism",
	  size = 20,
	  weight = 1000,
	  antialias = true,
	...
	surface.CreateFont( "DmgIndicator2" ,
	{ font = "Game Over",
	  size = 29,
	  weight = 500,
	 } );
	...
	local function DrawIndacators()
		for _, tblInfo in pairs(tblIndacators) do
			...
			draw.SimpleTextOutlined(tblInfo.String, "DmgIndicator", posIndicatorPos.x, posIndicatorPos.y, clrDrawColor, 1, 1, 1, clrDrawColorBoarder)
