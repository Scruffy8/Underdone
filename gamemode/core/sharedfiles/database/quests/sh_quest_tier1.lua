...
Quest.PrintName = "Kill zombies 3 (Repeat)"
Quest.Story = "Zombies are always attacking newcomers here. Say, tell you what, you kill a couple of them things and I will give you some cash for it."
Quest.TurnInStory = "Nice job, I like the way you handled those zombies - let's do this more often."
Quest.QuestNeeded = "quest_killzombies2"
Quest.Level = 4
Quest.Repeat = true
Quest.AdjustExp = false
Quest.Kill = {}
Quest.Kill["zombie"] = 20
Quest.GainedExp = 20
Quest.GainedItems = {}
...
Quest.Level = 1
Quest.QuestSpot = { "zone_zombie", "spot_mining" }
Quest.ObtainItems = {}
...
Quest.QuestSpot = { "zone_zombie", "spot_oil" }
Quest.GainedExp = 30
Quest.GainedItems = {}
...
Quest.Story = "You'd think that fire zombies would kill themselves - dumb creatures - but they're actually a menace. Take them out or we might be overrun!"
Quest.QuestNeeded = "quest_killfirezombies"
Quest.Level = 5
Quest.Kill = {}
Quest.Kill["fire_zombie"] = 20
Quest.GainedExp = 100
...
Quest.Story = "You'd think that fire zombies would kill themselves - dumb creatures - but they're actually a menace. Take them out or we might be overrun!"
Quest.QuestNeeded = "quest_killfirezombies2"
Quest.Level = 6
Quest.Kill = {}
Quest.Kill["fire_zombie"] = 20
Quest.AdjustExp = false
...
Quest.Story = "Don't be fooled - ice zombies move as quick as any other. That being said, frostbite hurts and we don't want them around."
Quest.QuestNeeded = "quest_killicezombies"
Quest.Level = 8
Quest.Kill = {}
Quest.Kill["ice_zombie"] = 20
Quest.GainedExp = 120
...
Quest.Story = "Don't be fooled - ice zombies move as quick as any other. That being said, frostbite hurts and we don't want them around."
Quest.QuestNeeded = "quest_killicezombies2"
Quest.Level = 9
Quest.Kill = {}
Quest.AdjustExp = false
Quest.Repeat = true
...
Quest.Story = "They were bad enough when we could outrun them, but now there are new zombies which can jump over buildings! This has to be stopped!"
Quest.Level = 12
Quest.QuestNeeded = "quest_killfastzombies"
Quest.Kill = {}
Quest.Kill["fastzombie"] = 20
Quest.GainedExp = 200
Quest.GainedItems = {}
...
Quest.AdjustExp = false
Quest.Repeat = true
Quest.QuestNeeded = "quest_killfastzombies2"
Quest.GainedExp = 75
Quest.GainedItems = {}
Quest.GainedItems["money"] = 400
Register.Quest(Quest)
...
Quest.PrintName = "Counter-Assasin 1"
...
Quest.PrintName = "Counter-Assasin 2"
Quest.QuestNeeded = "quest_killvorts"
Quest.Story = "Aliens? In my Earth? It's more likely than you think. Get rid of these horrible things!"
Quest.Level = 50
Quest.Kill = {}
Quest.Kill["vortigaunt"] = 20
...
Quest.PrintName = "Counter-Assasin Repeat"
Quest.QuestNeeded = "quest_killvorts2"
Quest.Story = "Aliens? In my Earth? It's more likely than you think. Get rid of these horrible things!"
Quest.Level = 50
Quest.Kill = {}
Quest.Kill["vortigaunt"] = 20
