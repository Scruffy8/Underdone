...
Item.Stackable = true
Item.SellPrice = 20
Item.ItemColor = Color( 200, 255, 200 )
Item.Weight = 1
Register.Item(Item)
...
local Item = QuickCreateItemTable(BaseAmmo, "item_buckshotammo_big", "Buckshot Pack", "100 Buckshot shells", "icons/item_buckshot")
Item = AddAmmo(Item, 100, "buckshot")
Item.ItemColor = Color( 200, 255, 200 )
Item.Model = "models/Items/BoxBuckshot.mdl"
Item.Stackable = true
Item.SellPrice = 220
...
local function funcPortal( plyPlayer, Item )
	...
	if string.lower(game.GetMap()) == map then
		...
		plyPlayer:EmitSound( "beams/beamstart5.wav" )
		plyPlayer:SetPos( vec + Vector( 0, 0, 40 ) )
		plyPlayer:RemoveItem( Item.Name, 1 )
	end
end

local Item = QuickCreateItemTable(BaseItem, "item_portal_otcnl_1", "Portal: Exiled Hideout", "Teleports you to desired destination.", "icons/bt/mat_cloth")
Item.Map = "rp_outercanals"
...
local Item = QuickCreateItemTable(BaseItem, "item_portal_otcnl_2", "Portal: Resistance Outpost", "Teleports you to desired destination.", "icons/bt/mat_cloth")
Item.Map = "rp_outercanals"
Item.Zone = "zone_vil_2"
Item.Spot = "spot_spawn"
Item.Stackable = true
function Item:Use( plyPlayer, Item )
	funcPortal( plyPlayer, Item )
...
local Item = QuickCreateItemTable(BaseItem, "item_portal_otcnl_3", "Portal: Helios Enrichment Center", "Teleports you to desired destination.", "icons/bt/mat_cloth")
Item.Map = "rp_outercanals"
Item.Zone = "zone_vil_3"
Item.Spot = "spot_spawn"
Item.Stackable = true
function Item:Use( plyPlayer, Item )
	funcPortal( plyPlayer, Item )
