...
local Item = QuickCreateItemTable(BaseItem, "scrl_zombie", "Mystic Zombie Scroll", "You can feel some unknown mystic power from this scroll.", "icons/junk_metalcan1")
Item.Stackable = true
