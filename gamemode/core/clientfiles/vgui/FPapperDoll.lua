...
function PANEL:Init()
	...
	self.ArmorRatingLabel = CreateGenericLabel(self, "UiBold", Format( langopt[lang_cur].pdoll_totalarmor, LocalPlayer():GetArmorRating() ), clrDrakGray)
end
...
function PANEL:Think()
	self.ArmorRatingLabel:SetText( Format( langopt[lang_cur].pdoll_totalarmor, LocalPlayer():GetArmorRating() ) )
end
